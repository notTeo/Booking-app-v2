...
const features = [
  {
    ...
    desc: 'Let clients book 24/7 from any device. Automated reminders cut no-shows dramatically.',
  },
  {
    icon: faStore,
    title: 'Shop Management',
    desc: 'Manage multiple locations, staff, services, and availability from one clean dashboard.',
  },
  {
    icon: faCreditCard,
    title: 'Subscriptions',
    desc: 'Offer membership plans to loyal clients and unlock predictable, recurring revenue.',
  },
  {
    icon: faUsers,
    title: 'Team Management',
    desc: 'Assign roles, track performance, and coordinate schedules across your entire team.',
  },
  {
    icon: faMobile,
    title: 'Mobile-Ready',
    desc: 'A seamless experience on every screen — your clients book on the go, effortlessly.',
  },
  {
    icon: faChartLine,
    title: 'Analytics',
    desc: 'Track revenue, peak hours, and client retention with clear, actionable reports.',
  },
];
...
const steps = [
  {
    ...
    desc: 'Sign up in seconds. No credit card required. Get started on the free plan today.',
  },
  {
    num: '02',
    icon: faGear,
    title: 'Set up your shop',
    desc: 'Add your services, set your hours, and invite your team — all in under 10 minutes.',
  },
  {
    num: '03',
    icon: faCalendarCheck,
    title: 'Accept bookings',
    desc: 'Share your booking link and start receiving real appointments immediately.',
  },
];
...
const testimonials = [
  {
    quote:
      'Bookly completely transformed how we run our barbershop. Clients love the easy online booking and we\'ve cut no-shows by over 60%.',
    name: 'Marcus Thompson',
    role: 'Owner, The Sharp Cut',
    initials: 'MT',
  },
  {
    quote:
      'We went from a messy paper calendar to a fully automated system in one afternoon. The dashboard is clean and our whole team uses it daily.',
    name: 'Sofia Rivera',
    role: 'Manager, Studio Glam',
    initials: 'SR',
  },
  {
    quote:
      'The subscription feature alone paid for Pro in the first month. Our regulars love the membership plan and we love the predictable revenue.',
    name: 'James Okafor',
    role: 'Owner, Fade Culture',
    initials: 'JO',
  },
];
    ...
    <div className="home-page">
        ...
        {menuOpen && (
          <>
            ...
            <div className="home-mobile-menu">
              <a href="#features" className="home-mobile-link" onClick={closeMenu}>Features</a>
              <a href="#how"      className="home-mobile-link" onClick={closeMenu}>How It Works</a>
              <a href="#pricing"  className="home-mobile-link" onClick={closeMenu}>Pricing</a>
              ...
              <Link to="/register" onClick={closeMenu} style={{ display: 'block' }}>
      ...
      <section className="home-hero">
        <div className="home-hero-badge">
          Booking platform for barbershops &amp; salons
        </div>
        ...
        <div className="home-hero-ctas">
          ...
          <button className="home-btn-ghost">See Demo</button>
        </div>
      </section>
      ...
      <section id="features" className="home-section">
        <div className="home-container">
          <div className="home-section-header">
            <span className="home-label">Features</span>
            <h2 className="home-section-title">Everything you need to run your shop</h2>
            <p className="home-section-sub">
              Built for modern barbershops and salons that want to grow without the overhead.
            </p>
          </div>
      ...
      <section id="how" className="home-section">
        <div className="home-container">
          <div className="home-section-header">
            <span className="home-label">How It Works</span>
            <h2 className="home-section-title">Up and running in minutes</h2>
            <p className="home-section-sub">
              Three simple steps to a fully automated booking experience.
            </p>
          </div>
      ...
      <section id="pricing" className="home-section">
        <div className="home-container">
          <div className="home-section-header">
            <span className="home-label">Pricing</span>
          ...
          <div className="home-pricing-grid">
            ...
            <div className="home-price-card">
              ...
              <p className="home-price-desc">
                Perfect for solo barbers or shops just getting started.
              </p>
                ...
                {freePlan.map(f => (
                  <li key={f.label} className={f.included ? '' : 'muted'}>
                    <FontAwesomeIcon
                      ...
                      className={f.included ? 'feat-check' : 'feat-x'}
                    />
                    {f.label}
                  </li>
                ))}
              ...
              <Link to="/register" style={{ display: 'block' }}>
                <button className="home-btn-ghost home-price-cta">
                  Get Started Free
                </button>
              </Link>
            </div>
            ...
            <div className="home-price-card home-price-card--pro">
              ...
              <p className="home-price-desc">
                For growing shops that need full power and zero limits.
              </p>
              <hr className="home-price-divider" />
              <ul className="home-price-features">
                {proPlan.map(f => (
      ...
      <section className="home-section">
        <div className="home-container">
          <div className="home-section-header">
            <span className="home-label">Testimonials</span>
            <h2 className="home-section-title">Loved by shop owners</h2>
            <p className="home-section-sub">
              Real results from real barbershops and salons using Bookly every day.
            </p>
          </div>
            ...
            {testimonials.map(t => (
              <div key={t.name} className="home-testimonial-card">
                <div className="home-testimonial-stars">
                  {[...Array(5)].map((_, i) => (
                    <FontAwesomeIcon key={i} icon={faStar} style={{ marginRight: '0.2rem' }} />
                  ))}
                </div>
          ...
          <div className="home-footer-inner">
            ...
            <div className="home-footer-brand">
              ...
              <p className="home-footer-brand-desc">
                The booking platform built for barbershops and salons that take
                their business seriously.
              </p>
              <div className="home-footer-socials">
                <a href="#" className="home-footer-social" aria-label="Instagram">
                  <FontAwesomeIcon icon={faInstagram} />
                </a>
                <a href="#" className="home-footer-social" aria-label="Twitter">
                  <FontAwesomeIcon icon={faTwitter} />
                </a>
                <a href="#" className="home-footer-social" aria-label="Facebook">
